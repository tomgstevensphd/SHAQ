...
(unless (packagep 'drakma)
  ...
  (sleep 3))
#|OLD WAY--my-drakma-load.lisp now loads quicklisp first if needed
...
;; (TESTDC)
;; THIS WORKS
;; 2017-11-07; 1:29pm GOT FOLLOWING MESSAGE:
#|  In http-dcon, v1-body-or-stream= <!DOCTYPE HTML PUBLIC "-//IETF//DTD HTML 2.0//EN">
<html><head>
...
in the server error log.</p>
 ...
 v2-status-code= 500
 v3-headers= ((DATE . Tue, 07 Nov 2017 21:28:10 GMT) (SERVER . Apache/2.4.25 (Red Hat) OpenSSL/1.0.1e-fips) (CONTENT-LENGTH . 532) (CONTENT-TYPE . text/html; charset=iso-8859-1) (CONNECTION . close) (CONTENT-LANGUAGE . en))
 v4-uri3-newURI= http://web.csulb.edu/~tstevens/test/SendData.php
 v5-stream= #<FLEXI-STREAMS:FLEXI-IO-STREAM 23F144CF>
 v6-must-close= T
 v7-reason-phrase= Internal Server Error|#
